...
def main():
    ...
    for iteration in range(iterations):
        ...
        f.close()
        os.system("hdfs dfs -put -f 'inputAnt.txt' /input_kos_{}".format(iteration));
        os.system("hadoop jar /code/hadoop-streaming.jar \
		-D mapreduce.map.memory.mb=2048 \
		-D mapreduce.reduce.memory.mb=2048 \
		-file /code/kos_mapper.py -mapper /code/kos_mapper.py -file /code/kos_reducer.py   -reducer /code/kos_reducer.py \
        -input /input_kos_{} -output /output_kos_{}".format(iteration, iteration))
        localBest = 99999999999999
        
        per_hdfs = os.popen('hdfs dfs -cat /output_kos_{}/part-00000'.format(iteration)).read()
