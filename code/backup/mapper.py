...
for line in sys.stdin:
    ...
    mm = corpora.mmcorpus.MmCorpus('/code/docword.kos.txt_.mm') # `mm` document stream now has random access

    # mm = pickle.load(open('/code/mm.obj', 'rb'))

    # mm = corpora.mmcorpus.MmCorpus('/code/docword.kos.txt_.mm')
    
    # dictionary = pickle.load(open('/code/dictx.obj', 'rb'))
