...
def main():
    ...
    for iteration in range(iterations):
        ...
        f.close()
        os.system("hdfs dfs -put -f 'inputAnt.txt' /input_{}".format(iteration));
        os.system("hadoop jar /code/hadoop-streaming.jar \
		-D mapreduce.map.memory.mb=2048 \
		-D mapreduce.reduce.memory.mb=2048 \
		-file /code/mapper.py -mapper /code/mapper.py -file /code/reducer.py   -reducer /code/reducer.py \
        -input /input_{} -output /output_{}".format(iteration, iteration))
        localBest = 99999999999999
        
        per_hdfs = os.popen('hdfs dfs -cat /output_{}/part-00000'.format(iteration)).read()
