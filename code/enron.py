...
def main():
    ...
    for iteration in range(iterations):
        ...
        f.close()
        os.system("hdfs dfs -put -f 'inputAnt.txt' /input_enron_{}".format(iteration));
        os.system("hadoop jar /code/hadoop-streaming.jar \
		-D mapreduce.map.memory.mb=2048 \
		-D mapreduce.reduce.memory.mb=2048 \
		-file /code/enron_mapper.py -mapper /code/enron_mapper.py -file /code/enron_reducer.py   -reducer /code/enron_reducer.py \
        -input /input_enron_{} -output /output_enron_{}".format(iteration, iteration))
        localBest = 99999999999999
        
        per_hdfs = os.popen('hdfs dfs -cat /output_enron_{}/part-00000'.format(iteration)).read()
